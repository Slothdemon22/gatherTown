...
import gatherSvg from "@/app/svgs/gatherSvg";
...
export default function RegistrationPage() {
   const handleSubmitsignIn = useCallback(
      async (e: FormEvent<HTMLFormElement>) => {
         ...
         console.log(name);
         const nameValidation = userSchemaSignIn
            .pick({ email: true })
            .safeParse({ email });
         const passwordValidation = userSchemaSignIn
            .pick({ password: true })
            .safeParse({ password });
               ...
               <div>
                  <div className="rounded-xl border border-blue-200 p-8 max-w-md bg-white">
                     <blockquote className="mb-4 text-[15px] leading-relaxed text-gray-600">
                        <span className="text-2xl text-blue-500"></span>Work,
                        connect, and collaborate in a virtual office that feels
                        real. Step into your 2D Metaverse workspace where
               ...
               <div className="mx-auto w-full max-w-md">
                  ...
                  <div className="mb-8 text-center">
                     ...
                     <p className="text-gray-500">
                        Work, meet, and collaborate in an immersive online
                        workspace
                     </p>
                  </div>
