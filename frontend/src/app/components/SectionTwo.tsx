            ...
            <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <p className="text-sm font-medium tracking-wide text-purple-600 uppercase">Serendipitous moments</p>
                  ...
                  <p className="max-w-[600px] text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    Stop by someone&apos;s desk, say hi in the hallway, and bring back water cooler chats. No scheduling
                    required.
                  </p>
                </div>
              </div>
        ...
        >
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <p className="text-sm font-medium tracking-wide text-purple-600 uppercase">Productive conversations</p>
                  <h2 className="text-3xl font-bold tracking-tighter text-[#2B1F76] sm:text-4xl md:text-5xl">
                    Meet in the moment
                  </h2>
                  <p className="max-w-[600px] text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
