      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="grid lg:grid-cols-2 gap-12  justify-center items-center">
          ...
          <div className="flex flex-col justify-center">
            <h1 className="text-5xl sm:text-6xl font-bold text-white mb-6">Your Virtual HQ</h1>
            <p className="text-xl text-white/80 mb-8">
              Gather is a 2D Metaverse Office, where teams collaborate naturally—just like in real
              life. Walk around, chat, and work together in a virtual space that feels truly
              connected
            </p>
